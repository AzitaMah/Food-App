...
public class PersonUtilsTest {
    ...
    void test_findCommonPersons(){
        ...
        personList2.add(new Person("michael_j", "Michael", "Johnson", "+1122334455", LocalDate.of(1982, 9, 22), "password3", null));
        personList2.add(new Person("emily_w", "Emily", "Williams", "+9876543210", LocalDate.of(1995, 7, 8), "password4", null));
        personList2.add(new Person("admin", "Admin", "Admin", "+12333333", LocalDate.of(2000, 1, 1), "admin_password", null));
    ...
    void test_findCommonPersons_no_matches(){
        ...
        List<Person> personList2 = new ArrayList<>();
        personList2.add(new Person("michael", "Michael", "Johnson", "+1122334455", LocalDate.of(1982, 9, 22), "password3", null));
        personList2.add(new Person("emily", "Emily", "Williams", "+9876543210", LocalDate.of(1995, 7, 8), "password4", null));
        personList2.add(new Person("ad", "Admin", "Admin", "+12333333", LocalDate.of(2000, 1, 1), "admin_password", null));
